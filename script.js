(function () {
  ...
  if (!prefersReducedMotion) {
    spawnParticles(iceParticles, snowflakeSVG, 18, 'snowfall', 9, 20);
    spawnParticles(fireParticles, emberSVG, 14, 'emberrise', 6, 13);
  }
  ...
  if (toggleBtn) {
    toggleBtn.addEventListener('click', function () {
      ...
      if (iceParticles) iceParticles.hidden = next !== 'ice';
      if (fireParticles) fireParticles.hidden = next !== 'fire';
    });
  }
